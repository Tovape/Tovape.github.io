...
var arrLang = {
  ...
  'es': {
	...
	'introduction-text7': 	`Me gusta pensar que la vida es una pista de atletismo, y nosotros tenemos que correr en nuestra línea, puede que haya obstaculos o malformaciones en la pista pero cada paso cuenta.`,
	'introduction-text8': 	`❝Jump back and get back a little more ❞`,
	'introduction-text9':	`--The Qemists`,
  ...
  'ca': {
	...
	'introduction-text7': 	`M'agrada pensar que la vida es una pista d'atletisme, i nosotres tenim de córrer en la nostra línea, pot ser que hi hagi obstacles o malformacions a la pista però cada pas compte.`,
	'introduction-text8': 	`❝Jump back and get back a little more ❞`,
	'introduction-text9':	`--The Qemists`,
